...
#define KEYPAD_C1	CYGHWR_HAL_STM32_PIN_IN(C, 10, PULLUP)
#define KEYPAD_C2	CYGHWR_HAL_STM32_PIN_IN(C, 11, PULLUP)
#define KEYPAD_C3	CYGHWR_HAL_STM32_PIN_IN(C, 12, PULLUP)
#define KEYPAD_C4	CYGHWR_HAL_STM32_PIN_IN(C, 13, PULLUP)
#define KEYPAD_R1	CYGHWR_HAL_STM32_PIN_OUT(C,  6, PUSHPULL, NONE, 2MHZ)
#define KEYPAD_R2	CYGHWR_HAL_STM32_PIN_OUT(C,  7, PUSHPULL, NONE, 2MHZ)
#define KEYPAD_R3	CYGHWR_HAL_STM32_PIN_OUT(C,  8, PUSHPULL, NONE, 2MHZ)
#define KEYPAD_R4	CYGHWR_HAL_STM32_PIN_OUT(C,  9, PUSHPULL, NONE, 2MHZ)
