...
void USB_OTG_BSP_Init(USB_OTG_CORE_HANDLE *pdev)
{
  ...
  // Enable OTG clock
   ...
   reg32 |= BIT_(CYGHWR_HAL_STM32_RCC_AHB1ENR_OTGHS);
   reg32 |= BIT_(CYGHWR_HAL_STM32_RCC_AHB1ENR_OTGHSULPI);
   HAL_WRITE_UINT32(CYGHWR_HAL_STM32_RCC+CYGHWR_HAL_STM32_RCC_AHB1ENR, reg32);
